defmodule WebUI.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WebUI.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WebUI.Gettext, "errors", msg, opts)
    end
  end
